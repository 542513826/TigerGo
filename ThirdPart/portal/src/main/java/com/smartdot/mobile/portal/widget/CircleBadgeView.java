...
/**
 * 圆形小角标
 * badgeButton = (Button) findViewById(R.id.BadgeButton);
 * badge = new CircleBadgeView(this, badgeButton);
...
public class CircleBadgeView extends TextView{
    ...
    private static final int DEFAULT_CORNER_RADIUS_DIP = 6;
...
//     * 改变角标
//     */
//    public void changeBadge(int count) {
