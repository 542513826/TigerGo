...
package com.smartdot.mobile.portal.dialog;
...
public class CardPickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == android.R.id.button1) {
            ...
            setImageButtons(mCurrentTheme);
        } else if (v.getId() == R.id.theme_purple) {
            ...
            setImageButtons(mCurrentTheme);
        } else if (v.getId() == R.id.theme_green_light) {
            mCurrentTheme = ThemeHelper.CARD_LIGHT;
            setImageButtons(mCurrentTheme);
        } else if (v.getId() == R.id.theme_yellow) {
            mCurrentTheme = ThemeHelper.CARD_THUNDER;
            setImageButtons(mCurrentTheme);
        } else if (v.getId() == R.id.theme_orange) {
            mCurrentTheme = ThemeHelper.CARD_SAND;
            setImageButtons(mCurrentTheme);
        } else if (v.getId() == R.id.theme_red) {
