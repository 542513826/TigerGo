...
import com.smartdot.mobile.portal.activity.ZXingActivity;
...
public class ConversionListFragment extends Fragment
    ...
    private void reconnect(String token) {
        ...
        if (mContext.getApplicationInfo().packageName.equals(PortalApplication.getCurProcessName(mContext.getApplicationContext()))) {
