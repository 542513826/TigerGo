...
/*
<!--圆角头像-->
    <declare-styleable userName="SelectableRoundedImageView">
        <attr userName="sriv_left_top_corner_radius" format="dimension" />
        <attr userName="sriv_right_top_corner_radius" format="dimension" />
        <attr userName="sriv_left_bottom_corner_radius" format="dimension" />
        <attr userName="sriv_right_bottom_corner_radius" format="dimension" />
        <attr userName="sriv_border_width" format="dimension" />
        <attr userName="sriv_border_color" format="color" />
        <attr userName="sriv_oval" format="boolean" />
        <attr userName="android:scaleType" />
    </declare-styleable>
