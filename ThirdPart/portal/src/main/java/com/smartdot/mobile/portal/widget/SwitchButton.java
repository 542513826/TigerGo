package com.smartdot.mobile.portal.widget;
...
/*
<declare-styleable userName="SwitchButton">
 <attr userName="kswThumbDrawable" format="reference"/>
 <attr userName="kswThumbColor" format="color|reference"/>
 <attr userName="kswThumbMargin" format="dimension|reference"/>
 <attr userName="kswThumbMarginTop" format="dimension|reference"/>
 <attr userName="kswThumbMarginBottom" format="dimension|reference"/>
 <attr userName="kswThumbMarginLeft" format="dimension|reference"/>
 <attr userName="kswThumbMarginRight" format="dimension|reference"/>
 <attr userName="kswThumbWidth" format="dimension|reference"/>
 <attr userName="kswThumbHeight" format="dimension|reference"/>
 <attr userName="kswThumbRadius" format="dimension|reference"/>
 <attr userName="kswBackRadius" format="dimension|reference"/>
 <attr userName="kswBackDrawable" format="reference"/>
 <attr userName="kswBackColor" format="color|reference"/>
 <attr userName="kswFadeBack" format="boolean"/>
 <attr userName="kswBackMeasureRatio" format="float"/>
 <attr userName="kswAnimationDuration" format="integer"/>
 <attr userName="kswTintColor" format="color|reference"/>
 <attr userName="kswTextOn" format="string"/>
 <attr userName="kswTextOff" format="string"/>
 <attr userName="kswTextMarginH" format="dimension"/>
 </declare-styleable>
 */
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (!mIsThumbUseDrawable && mThumbColor == null) {
            mThumbColor = MyColorUtils.generateThumbColorWithTintColor(mTintColor);
        ...
        if (!mIsBackUseDrawable && mBackColor == null) {
            mBackColor = MyColorUtils.generateBackColorWithTintColor(mTintColor);
