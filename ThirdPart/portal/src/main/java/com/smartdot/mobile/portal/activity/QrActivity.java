...
public class QrActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void createQRcode() {
        final String value = String.format(getResources().getString(R.string.qrcode_value));
        new AsyncTask<Void, Void, Bitmap>() {

            @Override
            protected Bitmap doInBackground(Void... voids) {
                return QRCodeEncoder.syncEncodeQRCode(value, BGAQRCodeUtil.dp2px(QrActivity.this, 150));
            }
            ...
            protected void onPostExecute(Bitmap bitmap) {
                ...
                if (bitmap != null) {
                    if (bitmap != null) {
                        ...
                        Toast.makeText(QrActivity.this, "生成二维码失败", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        }.execute();
